...
export interface AddMissionToCampaign {
  owner: string;
  campaignId: string;
  name: string;
  description: string;
...
export interface CompleteMissionFromHook {
  campaignId: string;
  missionId: string;
  userAddress: string;
}
...
function createBaseEditCampaign(): EditCampaign {
  return {
    owner: "",
    name: "",
    description: "",
...
export const EditCampaign = {
  encode(message: EditCampaign, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.owner !== "") {
      writer.uint32(18).string(message.owner);
    }
    if (message.name !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): EditCampaign {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEditCampaign();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
  ...
  fromJSON(object: any): EditCampaign {
    return {
      owner: isSet(object.owner) ? String(object.owner) : "",
      name: isSet(object.name) ? String(object.name) : "",
      description: isSet(object.description) ? String(object.description) : "",
  ...
  toJSON(message: EditCampaign): unknown {
    const obj: any = {};
    message.owner !== undefined && (obj.owner = message.owner);
    message.name !== undefined && (obj.name = message.name);
    message.description !== undefined && (obj.description = message.description);
  ...
  fromPartial<I extends Exact<DeepPartial<EditCampaign>, I>>(object: I): EditCampaign {
    const message = createBaseEditCampaign();
    message.owner = object.owner ?? "";
    message.name = object.name ?? "";
    message.description = object.description ?? "";
...
function createBaseStartCampaign(): StartCampaign {
  return { owner: "", campaignId: "" };
}

export const StartCampaign = {
  encode(message: StartCampaign, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.owner !== "") {
      writer.uint32(10).string(message.owner);
    }
    if (message.campaignId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): StartCampaign {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseStartCampaign();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): StartCampaign {
    return {
      owner: isSet(object.owner) ? String(object.owner) : "",
      campaignId: isSet(object.campaignId) ? String(object.campaignId) : "",
    };
  ...
  toJSON(message: StartCampaign): unknown {
    const obj: any = {};
    message.owner !== undefined && (obj.owner = message.owner);
    message.campaignId !== undefined && (obj.campaignId = message.campaignId);
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<StartCampaign>, I>>(object: I): StartCampaign {
    const message = createBaseStartCampaign();
    message.owner = object.owner ?? "";
    message.campaignId = object.campaignId ?? "";
    return message;
...
function createBaseAddMissionToCampaign(): AddMissionToCampaign {
  return { owner: "", campaignId: "", name: "", description: "", missionType: "", weight: "", claimStartDate: "" };
}

export const AddMissionToCampaign = {
  encode(message: AddMissionToCampaign, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.owner !== "") {
      writer.uint32(10).string(message.owner);
    }
    if (message.campaignId !== "") {
    ...
    if (message.claimStartDate !== "") {
      writer.uint32(58).string(message.claimStartDate);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): AddMissionToCampaign {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAddMissionToCampaign();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): AddMissionToCampaign {
    return {
      owner: isSet(object.owner) ? String(object.owner) : "",
      campaignId: isSet(object.campaignId) ? String(object.campaignId) : "",
      name: isSet(object.name) ? String(object.name) : "",
  ...
  toJSON(message: AddMissionToCampaign): unknown {
    const obj: any = {};
    message.owner !== undefined && (obj.owner = message.owner);
    message.campaignId !== undefined && (obj.campaignId = message.campaignId);
    message.name !== undefined && (obj.name = message.name);
  ...
  fromPartial<I extends Exact<DeepPartial<AddMissionToCampaign>, I>>(object: I): AddMissionToCampaign {
    const message = createBaseAddMissionToCampaign();
    message.owner = object.owner ?? "";
    message.campaignId = object.campaignId ?? "";
    message.name = object.name ?? "";
...
function createBaseCompleteMissionFromHook(): CompleteMissionFromHook {
  return { campaignId: "", missionId: "", userAddress: "" };
}

export const CompleteMissionFromHook = {
  encode(message: CompleteMissionFromHook, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.campaignId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CompleteMissionFromHook {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCompleteMissionFromHook();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): CompleteMissionFromHook {
    return {
      campaignId: isSet(object.campaignId) ? String(object.campaignId) : "",
      missionId: isSet(object.missionId) ? String(object.missionId) : "",
      userAddress: isSet(object.userAddress) ? String(object.userAddress) : "",
  ...
  toJSON(message: CompleteMissionFromHook): unknown {
    const obj: any = {};
    message.campaignId !== undefined && (obj.campaignId = message.campaignId);
    message.missionId !== undefined && (obj.missionId = message.missionId);
    message.userAddress !== undefined && (obj.userAddress = message.userAddress);
  ...
  fromPartial<I extends Exact<DeepPartial<CompleteMissionFromHook>, I>>(object: I): CompleteMissionFromHook {
    const message = createBaseCompleteMissionFromHook();
    message.campaignId = object.campaignId ?? "";
    message.missionId = object.missionId ?? "";
    message.userAddress = object.userAddress ?? "";
